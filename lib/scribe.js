...
exports.render = async (label, report, asHTML) => {
  ...
  // optionall allow rendering as HTML instead of PDF
  if (asHTML) {
    debug(`writing out to ${filename}.html.`);
    // write the file to disk
    await fs.promises.writeFile(filename.concat('.html'), compiled);
