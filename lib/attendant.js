...
const isMasterProcess = process.env.NODE_APP_INSTANCE === '0';

const dashboardQuery = `
  SELECT display_name FROM dashboards JOIN schedules_dashboards
...
const queries = {
  schedules: db.prepare(`
    SELECT s.id, s.subject, s.body, s.cron, s.group_id as userGroupId, s.is_running,
